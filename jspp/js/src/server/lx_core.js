...
lx.log = function (data, category = 'common') {
    __exec__.log(data, category);
};

lx.logError = function(data, category = 'common') {
    __exec__.error(data, category);
};
...
lx.genId = (function() {
    ...
    return function () {
        ...
        let id = prefix + '_' + lx.Math.decChangeNotation(idCounter, 62);
        idCounter++;
        return id;
    }
})();
