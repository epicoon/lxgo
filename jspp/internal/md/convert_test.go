...
func TestConvert(t *testing.T) {
	cases := []struct {
		...
		{"unordered_list_nested_item_wraps", "- outer\n  - inner wraps\n    onto here\n  - inner two\n- outer two", "<div class=\"lx-md-container\"><ul><li>outer<ul><li>inner wraps onto here</li><li>inner two</li></ul></li><li>outer two</li></ul></div>"},
	}
